 ...
 * Uses notify-send (libnotify) to communicate with the system notification daemon.
 * Works on Linux with any notification daemon (dunst, mako, swaync, etc.).
 ...
 * Works with any notification daemon (dunst, mako, swaync, etc.).
 */
const notify = (title: string, body: string): void => {
    const args = ["--app-name=pi", title];
